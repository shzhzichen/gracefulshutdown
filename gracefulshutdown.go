...
To install run:
	...
	go get github.com/shzhzichen/gracefulshutdown
...
When callbacks return, the application will exit with os.Exit(0)
	...
	import (
		...
		"github.com/shzhzichen/gracefulshutdown"
		"github.com/shzhzichen/gracefulshutdown/shutdownmanagers/posixsignal"
	)
...
message to correct instance via http on port 7999.
	...
	import (
		...
		"github.com/shzhzichen/gracefulshutdown"
		"github.com/shzhzichen/gracefulshutdown/shutdownmanagers/awsmanager"
		"github.com/shzhzichen/gracefulshutdown/shutdownmanagers/posixsignal"
	)
